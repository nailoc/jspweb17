...
<body>
	...
	<br>
	<div class="mypic">
		<img src="upload/<%=mymem.getPic() %>" alt="personal pic">
	</div>
	<form id="mem-form" action="modifypro.jsp" method="POST" enctype="multipart/form-data">
		...
		<input type="text" name="phn" placeholder="전화번호" value="<%=mymem.getPhone() %>">
		<input type="file" id="attpic" name="pic">
